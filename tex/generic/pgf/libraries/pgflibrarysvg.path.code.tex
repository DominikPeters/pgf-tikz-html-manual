...
\newdimen\pgf@lib@svg@subpath@start@x
\newdimen\pgf@lib@svg@subpath@start@y
...
\def\pgf@lib@svg@moveto{%
  ...
  \pgf@lib@svg@subpath@start@x=\pgf@lib@svg@last@x
  \pgf@lib@svg@subpath@start@y=\pgf@lib@svg@last@y
...
\def\pgf@lib@svg@closepath{%
  \pgf@lib@svg@finish@prev
  \pgfpathclose
  \pgf@lib@svg@last@x=\pgf@lib@svg@subpath@start@x
  \pgf@lib@svg@last@y=\pgf@lib@svg@subpath@start@y
  \let\pgf@lib@svg@finish@prev=\relax
  \pgf@lib@svg@clear@bezier@quad%
