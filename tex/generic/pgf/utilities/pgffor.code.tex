...
\def\pgffor@multiassignfinal#1/#2/\relax{%
  ...
  \ifx\pgffor@test\pgfutil@empty%
    \ifpgffor@repeat%
      \expandafter\def\expandafter\pgffor@valuerest\expandafter{\pgffor@temp//\relax}% repeat last value
    \else%
      \expandafter\def\expandafter\pgffor@valuerest\expandafter{//\relax}% interpret as empty
    \fi%
  \else%
