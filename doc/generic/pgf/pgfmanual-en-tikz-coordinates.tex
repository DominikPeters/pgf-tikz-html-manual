...
\section[tikz-coordinates]{Specifying Coordinates}
...
\begin{tikzpicture}
  \node (shape)   at (0,2)  [draw] {\texttt{class Shape}};
  \node (rect)    at (-2,0) [draw] {\texttt{class Rectangle}};
  \node (circle)  at (2,0)  [draw] {\texttt{class Circle}};
  \node (ellipse) at (6,0)  [draw] {\texttt{class Ellipse}};
...
\end{codeexample}
    ...
    Note that in |(|\meta{c}\verb! |- !\meta{d}|)| the coordinates
