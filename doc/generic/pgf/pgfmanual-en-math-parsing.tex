...
\def\mathlink#1{\declare{#1}}
\begin{itemize}
\item \mathlink{abs}, \mathlink{acos}, \mathlink{add}, \mathlink{and}, \mathlink{array}, \mathlink{asin}, \mathlink{atan}, \mathlink{atan2}, \mathlink{bin}, \mathlink{ceil}, \mathlink{cos}, \mathlink{cosec}, \mathlink{cosh}, \mathlink{cot}, \mathlink{deg}, \mathlink{depth}, \mathlink{dim}, \mathlink{div}, \mathlink{divide}, \mathlink{e}, \mathlink{equal}, \mathlink{factorial}, \mathlink{false}, \mathlink{floor}, \mathlink{frac}, \mathlink{gcd}, \mathlink{greater}, \mathlink{height}, \mathlink{hex}, \mathlink{Hex}, \mathlink{int}, \mathlink{ifthenelse}, \mathlink{iseven}, \mathlink{isodd}, \mathlink{isprime}, \mathlink{less}, \mathlink{ln}, \mathlink{log10}, \mathlink{log2}, \mathlink{max}, \mathlink{min}, \mathlink{mod}, \mathlink{Mod}, \mathlink{multiply}, \mathlink{neg}, \mathlink{not}, \mathlink{notequal}, \mathlink{notgreater}, \mathlink{notless}, \mathlink{oct}, \mathlink{or}, \mathlink{pi}, \mathlink{pow}, \mathlink{rad}, \mathlink{rand}, \mathlink{random}, \mathlink{real}, \mathlink{rnd}, \mathlink{round}, \mathlink{scalar}, \mathlink{sec}, \mathlink{sign}, \mathlink{sin}, \mathlink{sinh}, \mathlink{sqrt}, \mathlink{subtract}, \mathlink{tan}, \mathlink{tanh}, \mathlink{true}, \mathlink{veclen}, \mathlink{width}
\end{itemize}
