...
\newenvironment{shape}[1]{
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{%
      \pgfmanualpdflabel{#1}{}%
      \definitionspan{\textbf{Shape} \texttt{\declare{#1}}}%
    }%
...
\def\extractkey#1\@nil{%
  ...
  \else%
    ...
    \else
      ...
      \decompose#1/\nil%
        \definitionspan{\texttt{\declare{#1}}}%
  ...
  \else%
    ...
    \else
      \pgfmanualentryheadline{%
        ...
        \pgfmanualdecomposecount=0\relax%
        \decompose#1/\nil%
        \definitionspan{\texttt{\declare{#1}=}#2}%
...
\def\extractdefault#1#2(default #3)\@nil{%
  \pgfmanualentryheadline{%
    ...
    \pgfmanualdecomposecount=0\relax%
    \decompose#1/\nil%
    \definitionspan{\texttt{\declare{#1}\opt{=}}\opt{#2}}%
