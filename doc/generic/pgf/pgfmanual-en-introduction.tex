...
\BlockClassSingle{manual-version}{Manual for Version \pgfversion\ -- \the\year{}}
\BlockClassSingle{manual-author}{Till Tantau}
\BlockClassSingle{manual-authorship-explanation}{%
Editor of this documentation.} 
...
and is produced using the \texttt{lwarp} package.}
}
