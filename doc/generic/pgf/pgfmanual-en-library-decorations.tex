...
\section[library-decorations]{Decoration Library}
...
in section~\ref{fpu-install-only}).
%
...
\end{codeexample}
    ...
    \begin{key}{/pgf/decoration/foot of (initially human)}
        ...
        \begin{tabular}{ll}
            ...
            \texttt{gnome} & \tikz [baseline,decoration={footprints,foot of=gnome}] \fill [decorate] (0,0) -- (6,0); \\[3em]
            \texttt{human} & \tikz [baseline,decoration={footprints,foot of=human}] \fill [decorate] (0,0) -- (6,0); \\[3em]
            \texttt{bird} & \tikz [baseline,decoration={footprints,foot of=bird}] \fill [decorate] (0,0) -- (6,0); \\[3em]
            \texttt{felis silvestris} & \tikz [baseline,decoration={footprints,foot of=felis silvestris}] \fill [decorate] (0,0) -- (6,0); \\[3em]
        \end{tabular}
    \end{key}
\end{decoration}
