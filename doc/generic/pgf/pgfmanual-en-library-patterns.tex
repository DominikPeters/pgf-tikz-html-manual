...
\section[library-patterns]{Pattern Library}
...
\begin{command}{\pgfdeclarepattern\marg{config}}
    ...
    \end{key}
    %
    \begin{key}{/pgf/patterns/parameters=\meta{comma separated list} (default \normalfont empty)}
    ...
    \end{key}
    %
    \begin{key}{/pgf/patterns/defaults=\meta{comma separated list} (default \normalfont empty)}
    ...
    \end{key}
    %
    \begin{key}{/pgf/patterns/tile transformation=\meta{pgftransformation} (default \normalfont empty)}
    ...
    \end{key}
    %
    \begin{key}{/pgf/patterns/set up code=\meta{code} (default \normalfont empty)}
