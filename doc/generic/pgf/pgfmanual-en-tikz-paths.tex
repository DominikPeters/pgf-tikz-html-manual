...
\section[tikz-paths]{Syntax for Path Specifications}
\label{section-paths}
...
\begin{pathoperation}[noindex]{-|}{\meta{coordinate or cycle}}
    ...
    \pgfmanualpdflabel[\catcode`\|=12 ]{-bar/}{}%
...
\begin{pathoperation}{:}{\meta{animation attribute}|=|\marg{options}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-paths-animation-1.svg}]
