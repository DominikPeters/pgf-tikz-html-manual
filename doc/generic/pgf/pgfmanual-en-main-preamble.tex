...
\usepackage{silence}
\WarningFilter{latex}{Overfull \hbox (131.68803pt}
\WarningFilter{latex}{Reference `LWRlateximage-pgfmanual}
...
% LWARP can get confused by ampersands, so make a special command
\makeatletter
\def\nextcell{
    \unskip%
...
% \tracinglostchars=3 % DP: okay, but I don't know how to handle them?
