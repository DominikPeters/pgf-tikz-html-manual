...
\end{codeexample}
        ...
        \item \declare{|border code|=\meta{code}}. When this option is given,
            ...
            page. Thus, setting \meta{code} to |\pgfusepath{stroke}| draws a rectangle
            around the logical page. Setting \meta{code} to
            |\pgfsetlinewidth{3pt}\pgfusepath{stroke}| results in a thick (ugly) frame.
            Adding dashes and filling can result in arbitrarily funky and
            distracting borders.

            You can also call |\pgfusepath{discard}| and add your own path
