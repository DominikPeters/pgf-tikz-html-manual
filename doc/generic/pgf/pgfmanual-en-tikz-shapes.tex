...
\section[tikz-shapes]{Nodes and Edges}
\label{section-nodes}
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-shapes-animation-1.svg}]
\tikz
...
\begin{tikzpicture}
  ...
  \fill (x.north)      circle (2pt) node[above] {\texttt{north}}
        (x.north east) circle (2pt) node[above] {\texttt{north east}}
        (x.north west) circle (2pt) node[above] {\texttt{north west}}
        (x.west) circle (2pt)       node[left]  {\texttt{west}}
        (x.east) circle (2pt)       node[right] {\texttt{east}}
        (x.base) circle (2pt)       node[below] {\texttt{base}};
\end{tikzpicture}
...
\begin{BlockClass}{section-absolute-positioning}
...
page:
%
\begin{codeexample}[pre={\begin{BlockClass}{example-absolute-positioning-bottom-left}},post={\end{BlockClass}}]
\begin{tikzpicture}[remember picture,overlay]
...
%
\begin{codeexample}[pre={\begin{BlockClass}{example-absolute-positioning-center}},post={\end{BlockClass}}]
\begin{tikzpicture}[remember picture,overlay]
