...
\section[library-circuits]{Circuit Libraries}
...
\begin{tabular}{lccc}
  \emph{Key} & \emph{Appearance inside} & \emph{Appearance inside} & \emph{Appearance inside} \\
    ...
    \texttt{/tikz/and gate} \indexkey{/tikz/and gate} & \tikz[baseline,circuit logic IEC] \node[/tikz/and gate,label=] {}; & \tikz[baseline,circuit logic US]  \node[/tikz/and gate] {}; &  \tikz[baseline,circuit logic CDH] \node[/tikz/and gate] {}; \\
    \texttt{/tikz/nand gate} \indexkey{/tikz/nand gate} & \tikz[baseline,circuit logic IEC] \node[/tikz/nand gate,label=] {}; & \tikz[baseline,circuit logic US]  \node[/tikz/nand gate] {}; &  \tikz[baseline,circuit logic CDH] \node[/tikz/nand gate] {}; \\
    \texttt{/tikz/or gate} \indexkey{/tikz/or gate} & \tikz[baseline,circuit logic IEC] \node[/tikz/or gate,label=] {}; & \tikz[baseline,circuit logic US]  \node[/tikz/or gate] {}; &  \tikz[baseline,circuit logic CDH] \node[/tikz/or gate] {}; \\
    \texttt{/tikz/nor gate} \indexkey{/tikz/nor gate} & \tikz[baseline,circuit logic IEC] \node[/tikz/nor gate,label=] {}; & \tikz[baseline,circuit logic US]  \node[/tikz/nor gate] {}; &  \tikz[baseline,circuit logic CDH] \node[/tikz/nor gate] {}; \\
    \texttt{/tikz/xor gate} \indexkey{/tikz/xor gate} & \tikz[baseline,circuit logic IEC] \node[/tikz/xor gate,label=] {}; & \tikz[baseline,circuit logic US]  \node[/tikz/xor gate] {}; &  \tikz[baseline,circuit logic CDH] \node[/tikz/xor gate] {}; \\
    \texttt{/tikz/xnor gate} \indexkey{/tikz/xnor gate} & \tikz[baseline,circuit logic IEC] \node[/tikz/xnor gate,label=] {}; & \tikz[baseline,circuit logic US]  \node[/tikz/xnor gate] {}; &  \tikz[baseline,circuit logic CDH] \node[/tikz/xnor gate] {}; \\
    \texttt{/tikz/not gate} \indexkey{/tikz/not gate} & \tikz[baseline,circuit logic IEC] \node[/tikz/not gate,label=] {}; & \tikz[baseline,circuit logic US]  \node[/tikz/not gate] {}; &  \tikz[baseline,circuit logic CDH] \node[/tikz/not gate] {}; \\
    \texttt{/tikz/buffer gate} \indexkey{/tikz/buffer gate} & \tikz[baseline,circuit logic IEC] \node[/tikz/buffer gate,label=] {}; & \tikz[baseline,circuit logic US]  \node[/tikz/buffer gate] {}; &  \tikz[baseline,circuit logic CDH] \node[/tikz/buffer gate] {};
\end{tabular}
...
\begin{pgflibrary}{shapes.gates.logic.IEC}
    ...
    By default each gate is drawn with a symbol, $\texttt{\&}$ for |and| and
