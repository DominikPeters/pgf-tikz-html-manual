...
% % \include{pgfmanual-en-tikz-animations} % todo one broken example % codeexample needs to be told how to show animations
...
% \include{pgfmanual-en-base-external} % broken
...
% \include{pgfmanual-en-pgfsys-animations} % broken
