...
%\normalsize\texttt{https://github.com/pgf-tikz/pgf}}
...
\part[tutorials-guidelines]{Tutorials and Guidelines}
...
\include{pgfmanual-en-tutorial-Euclid} % two examples don't compile, using code only
...
\part[install]{Installation and Configuration}
...
\part[tikz]{Ti\emph{k}Z ist \emph{kein} Zeichenprogramm}
\label{part-tikz}
...
\include{standalone/pgfmanual-en-tikz-paths}
\include{pgfmanual-en-tikz-actions}
\include{pgfmanual-en-tikz-arrows}
\include{standalone/pgfmanual-en-tikz-shapes}
\include{standalone/pgfmanual-en-tikz-pics}
...
\include{pgfmanual-en-tikz-transparency} % Fadings commented out
\include{pgfmanual-en-tikz-decorations}
\include{pgfmanual-en-tikz-transformations}
\include{standalone/pgfmanual-en-tikz-animations}



\part[gd]{Graph Drawing}
\label{part-gd}
...
\include{pgfmanual-en-gd-algorithm-layer} % broken for unusual reason
...
\include{pgfmanual-en-library-math} % todo four codeexamples fail (endgroup, improper)
...
\include{pgfmanual-en-library-rdf} % broken with luatex
...
\include{standalone/pgfmanual-en-library-views}



\part[dv]{Data Visualization}
\label{part-dv}
...
\part[math]{Mathematical and Object-Oriented Engines}
...
\include{pgfmanual-en-base-transparency} % some examples broken, now using "code only"
\include{standalone/pgfmanual-en-base-animations}
\include{pgfmanual-en-base-internalregisters}
\include{pgfmanual-en-base-quick}



\part[pgfsys]{The System Layer}
\label{part-system}
...
\include{standalone/pgfmanual-en-pgfsys-animations}
