...
\section[tikz-animations]{Animations}
...
notations.
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-1.svg}]
\begin{tikzpicture}[
...
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-2.svg}]
...
\begin{key}{/tikz/animate=\meta{animation specification}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-3.svg}]
\tikz \node [fill, text = white, animate = {
  myself:fill = {0s = "red", 2s = "blue", begin on = click }}] {Click me};
\end{codeexample}
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-4.svg}]
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-5.svg}]
\tikzset{
...
\begin{key}{/tikz/animate/entry}
    ...
    pair.
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-6.svg}]
\tikz [animate = {
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-7.svg}]
\tikz [animate = {
  object = node, attribute = fill, time = 0s, value = red, entry,
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-8.svg}]
\tikz [animate = {
  object = node,  attribute = fill, time = 0s, value = red, entry,
...
\begin{key}{/tikz/animate/object=\meta{list of objects}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-9.svg}]
...
\end{codeexample}
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-10.svg}]
\tikz [animate = { object = b, :fill = {0s = "red", 2s = "blue",
                                        begin on = click },
...
\begin{key}{/tikz/animate/attribute=\meta{list of attributes}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-11.svg}]
...
\begin{key}{/tikz/animate/id=\meta{id} (initially default)}
    ...
    separate timelines:
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-12.svg}]
\tikz [animate = {
...
\begin{key}{/tikz/animate/time=\meta{time}\opt{|later|}}
    ...
    key:
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-13.svg}]
...
\end{codeexample}
    ...
    \begin{key}{/tikz/animate/fork=\meta{t} (default 0s later)}
        ...
        %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-14.svg}]
...
\begin{key}{/tikz/animate/scope=\meta{options}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-15.svg}]
...
opacity of a node:
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-16.svg}]
\tikz \node
...
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-17.svg}]
\tikz \node
  :fill opacity = { 0s="1", 2s="0", begin on=click }
...
colon syntax:
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-18.svg}]
\tikz \node
  :fill opacity = { 0s="1", 2s="0", begin on=click }
...
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-19.svg}]
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-20.svg}]
...
\begin{tikzanimateattribute}{text}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-21.svg}]
...
\end{codeexample}
    ...
    for scopes:
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-22.svg}]
...
\begin{tikzanimateattribute}{opacity, fill opacity, stroke opacity}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-23.svg}]
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-24.svg}]
...
\begin{tikzanimateattribute}{visible, stage}
    ...
    |true|.
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-25.svg}]
...
\end{codeexample}
    ...
    ``on stage''.
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-26.svg}]
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-27.svg}]
...
\begin{tikzanimateattribute}{dash, dash phase, dash phase}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-28.svg}]
\tikz \node :dash = { 0s="on 10pt off 1pt  phase 0pt",
                      2s="on 1pt  off 10pt phase 0pt", begin on=click}
  [fill = blue!20, draw = blue, ultra thick, circle] {Click me!};
\end{codeexample}
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-29.svg}]
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-30.svg}]
...
\begin{tikzanimateattribute}{path}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-31.svg}]
\tikz \node :path = {
...
\end{codeexample}
    ...
    \begin{itemize}
        ...
        \item As for the dash pattern, you must ensure that all paths in the
            ...
            four Bézier curves):
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-32.svg}]
\tikz \node :path = {
...
\end{codeexample}
    ...
    Here is an example:
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-33.svg}]
\tikz [very thick] {
  \node (node) at (-2,0)
    [fill = blue!20, draw = blue, very thick, circle] {Click me!};
  \draw :path = {
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-34.svg}]
...
\begin{tikzanimateattribute}{rotate}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-35.svg}]
...
\begin{tikzanimateattribute}{xskew, yskew, xslant, yslant}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-36.svg}]
\tikz \node :xskew = { 0s="0", 2s="45", begin on=click}
  [fill = blue!20, draw = blue, ultra thick, circle] {Click me!};
\end{codeexample}
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-37.svg}]
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-38.svg}]
\tikz \node :shift = { 0s="{(0,0)}", 2s="{(5mm,-5mm)}",
                       begin on=click}
  [fill = blue!20, draw = blue, ultra thick, circle] {Click me!};
\end{codeexample}

\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-39.svg}]
...
\begin{tikzanimateattribute}{shift}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-40.svg}]
\tikz \node :shift = { 0s = "{(0,0)}", 2s = "{(5mm,-5mm)}",
                       begin on = click }
  [fill = blue!20, draw = blue, ultra thick, circle] {Click me!};
\end{codeexample}
    ...
    \begin{key}{/tikz/animate/options/along=\marg{path}\meta{|sloped| or
        ...
        %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-41.svg}]
\tikz {
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-42.svg}]
\tikz {
  \draw [help lines] (-0.2,-0.2) grid (2.2,1.2);
  \draw (1,.5) circle [radius=1mm];
  \node :shift = {
...
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-43.svg}]
\tikz {
...
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-44.svg}]
\tikz {
  \draw [help lines] (-0.2,-0.2) grid (2.2,2.2);
...
\begin{key}{/tikz/animate/options/origin=\meta{coordinate}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-45.svg}]
\tikz {
  \draw [help lines] (-0.2,-0.2) grid (2.2,2.2);
  \node :rotate = { 0s="0", 2s="45", begin on=click,
                    origin = {(1,0)}}
...
\begin{key}{/tikz/animate/options/transform=\meta{transformation keys}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-46.svg}]
\tikz {
  \draw [help lines] (-0.2,-0.2) grid (2.2,2.2);
...
\end{codeexample}
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-47.svg}]
\tikz {
  \draw [help lines] (-0.2,-0.2) grid (2.2,2.2);
  \node :xshift = { 0s="0cm", 2s="5mm", begin on=click,
...
\begin{tikzanimateattribute}{position}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-48.svg}]
\tikz {
  \draw [help lines] (-0.2,-0.2) grid (2.2,1.2);
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-49.svg}]
\tikz {
  \draw [help lines] (-0.2,-0.2) grid (2.2,1.2);
  \draw (1,.5) circle [radius=1mm] (1.5,0) circle [radius=1mm];
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-50.svg}]
\tikz {
  \draw [help lines] (-0.2,-0.2) grid (2.2,1.2);
...
\begin{tikzanimateattribute}{view}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-51.svg}]
\tikz [very thick] {
  \node (node) [fill = blue!20, draw = blue, very thick, circle] {Click me!};
...
\begin{key}{/tikz/animate/base=\meta{options}}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-52.svg}]
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-53.svg}]
\tikz \node [fill = green, text = white] :fill =
...
\end{codeexample}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-54.svg}]
\tikz \node [fill = green, text = white] :fill =
    { 1s = "red" base, 2s = "blue", begin on = click }
  {Click me};
\end{codeexample}
...
\begin{key}{/tikz/animate/options/forever}
    ...
    ``freeze'' at the end.
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-55.svg}]
\tikz \node :fill = { 1s="red", 2s="blue", forever, begin on=click}
  [fill = green!50!black, text = white] {Click me};
\end{codeexample}
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-56.svg}]
...
\begin{key}{/tikz/animate/options/end=\meta{time}}
    ...
    4\,s.
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-57.svg}]
\tikz \node [fill = green!50!black, text = white]
...
\begin{key}{/tikz/animate/options/begin on=\meta{options}}
    ...
    \begin{key}{/pgf/animation/events/of=\meta{id}\opt{|.|\meta{type}}}
        ...
        %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-58.svg}]
\tikz [very thick] {
...
\end{codeexample}
    ...
    \begin{key}{/pgf/animation/events/of next=\meta{id}\opt{|.|\meta{type}}}
        ...
        %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-59.svg}]
\tikz [very thick] {
  \node (X) at (1,1.2)  [fill = blue!20, draw = blue, circle] {1};
...
\end{codeexample}
    ...
    \begin{key}{/pgf/animation/events/event=\meta{event name}}
        ...
        \begin{key}{/pgf/animate/events/click}
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-60.svg}]
...
\end{codeexample}
        ...
        \begin{key}{/pgf/animation/events/mouse down}
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-61.svg}]
...
\end{codeexample}
        ...
        \begin{key}{/pgf/animation/events/mouse up}
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-62.svg}]
...
\end{codeexample}
        ...
        \begin{key}{/pgf/animation/events/mouse over}
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-63.svg}]
...
\end{codeexample}
        ...
        \begin{key}{/pgf/animation/events/mouse move}
            ...
            object.
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-64.svg}]
...
\end{codeexample}
        ...
        \begin{key}{/pgf/animation/events/mouse out}
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-65.svg}]
...
\end{codeexample}
        ...
        \begin{key}{/pgf/animation/events/begin}
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-66.svg}]
\tikz \node [animate = {
...
\end{codeexample}
        ...
        \begin{key}{/pgf/animation/events/end}
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-67.svg}]
\tikz \node [animate = {
...
\end{codeexample}
    ...
    \begin{key}{/pgf/animation/events/repeat=\meta{number}}
        ...
        \meta{number} times.
        %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-68.svg}]
\tikz
  \node [animate = { myself: = {
...
\begin{key}{/tikz/animate/options/restart=\meta{choice} (default true)}
    ...
    \begin{itemize}
        ...
        \item |false| means that once the animation has started once, it will
            never be restarted.
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-69.svg}]
...
\end{codeexample}
        ...
        \item |when not active| means that the animation will restart when the
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-70.svg}]
\tikz \node :rotate = { 0s="0", 2s="90",
...
\begin{key}{/tikz/animate/options/repeats=\meta{specification}}
    ...
    \begin{itemize}
        \item Empty, in which case the timeline repeats forever.
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-71.svg}]
\tikz \node :rotate = { 0s = "0", 2s = "90",
...
\end{codeexample}
        ...
        \item A \meta{number} (like |2| or |3.25|), in which case the timeline
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-72.svg}]
\tikz \node :rotate = { 0s = "0", 2s = "90",
...
\end{codeexample}
        ...
        \item The text ``|for| \meta{time}'' (like |for 2s| or |for 300ms|), in
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-73.svg}]
\tikz \node :rotate = { 0s = "0", 2s = "90",
...
\end{codeexample}
    ...
    \begin{itemize}
        ...
        \item The text |accumulating|. This has the effect that each time the
            ...
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-74.svg}]
\tikz \node :rotate = { 0s = "0", 2s = "90", begin on = click,
                        repeats = accumulating }
    [fill = blue!20, draw = blue, ultra thick, circle] {Click me!};
\end{codeexample}
            %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-75.svg}]
\tikz \node :rotate = { 0s = "0", 2s = "90", begin on = click,
...
\end{codeexample}
    ...
    both.
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-76.svg}]
\tikz {
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-77.svg}]
\tikz {
  \foreach \i in {0,0.125,...,1} \draw (-0.9,.9-\i) -- ++(1.8,0);
  \node :yshift = { begin on = click,
                    0s = "0cm",
...
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-78.svg}]
\tikz {
  \foreach \i in {0,0.125,...,1} \draw (-0.9,.9-\i) -- ++(1.8,0);
  \node :yshift = { begin on = click,
                    0s = { exit control = {1}{0}, "0cm" },
...
\begin{key}{/tikz/animate/options/ease=\marg{fraction} (default 0.5)}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-79.svg}]
\tikz {
  \foreach \i in {0,0.125,...,1} \draw (-0.9,.9-\i) -- ++(1.8,0);
...
\begin{key}{/tikz/animate/options/stay}
    ...
    flat''.
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-80.svg}]
\tikz {
  \foreach \i in {0,0.125,...,1} \draw (-0.9,.9-\i) -- ++(1.8,0);
  \node :yshift = { begin on = click,
                    0s = "0cm",
...
\begin{key}{/tikz/animate/options/jump}
    ...
    %
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-81.svg}]
\tikz {
  \foreach \i in {0,0.125,...,1} \draw (-0.9,.9-\i) -- ++(1.8,0);
  \node :yshift = { begin on = click,
                    0s = "0cm",
...
%
\begin{codeexample}[imagesource={standalone/pgfmanual-en-tikz-animations-animation-82.svg}]
