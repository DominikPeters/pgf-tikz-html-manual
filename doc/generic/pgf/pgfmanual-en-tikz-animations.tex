...
%
\begin{codeexample}[width=2cm,preamble={\usetikzlibrary{animations}},animation list={0.5,1,1.5,2},]
...
\end{codeexample}
    ...
    %
\begin{codeexample}[width=4cm,preamble={\usetikzlibrary{animations}},animation list={0.5,1,1.5,2},]
\tikzset{
...
\begin{key}{/tikz/animate/options/begin on=\meta{options}}
    ...
    \begin{key}{/pgf/animation/events/of=\meta{id}\opt{|.|\meta{type}}}
        ...
        %
\begin{codeexample}[width=3cm,preamble={\usetikzlibrary{animations}},animation list={0.5,1,1.5,2},]
\tikz [very thick] {
