...
\begin{command}{\pgfsys@defineimage}
    ...
    %
    \begin{itemize}
        \item\declare{\texttt{\textbackslash{}pgf@filename}} File name of the image to be defined.
        \item\declare{\texttt{\textbackslash{}pgf@imagewidth}} Will be set to the desired (scaled)
            width of the image.
        \item\declare{\texttt{\textbackslash{}pgf@imageheight}} Will be set to the desired (scaled)
            height of the image.
    ...
    %
    \begin{itemize}
        \item \declare{\texttt{\textbackslash{}pgf@imagepage}} The desired page number to be
            extracted from a multi-page ``image''.
        \item\declare{\texttt{\textbackslash{}pgf@imagemask}} If set, it will be set to
            |/SMask x 0 R| where |x| is the \pdf\ object number of a soft mask
            to be applied to the image.
        \item\declare{\texttt{\textbackslash{}pgf@imageinterpolate}} If set, it will be set to
...
\begin{command}{\pgfsys@definemask}
    ...
    %
    \begin{itemize}
        \item \declare{\texttt{\textbackslash{}pgf@filename}}
            File name of the mask to be defined.
        \item \declare{\texttt{\textbackslash{}pgf@maskmatte}}
