...
%
\begin{itemize}
    \item \declare{\texttt{\textbackslash{}pgfsyssoftpath@movetotoken}} indicates a move-to
        operation. The two following numbers indicate the position to which the
        current point should be moved.
    \item \declare{\texttt{\textbackslash{}pgfsyssoftpath@linetotoken}} indicates a line-to
        operation.
    \item \declare{\texttt{\textbackslash{}pgfsyssoftpath@curvetosupportatoken}} indicates the first
        control point of a curve-to operation. The triple must be followed by a
        |\pgfsyssoftpath@curvetosupportbtoken|.
    \item \declare{\texttt{\textbackslash{}pgfsyssoftpath@curvetosupportbtoken}} indicates the second
        control point of a curve-to operation. The triple must be followed by a
        |\pgfsyssoftpath@curvetotoken|.
    \item \declare{\texttt{\textbackslash{}pgfsyssoftpath@curvetotoken}} indicates the target of a
        curve-to operation.
    \item \declare{\texttt{\textbackslash{}pgfsyssoftpath@rectcornertoken}} indicates the corner of a
        rectangle on the soft path. The triple must be followed by a
        |\pgfsyssoftpath@rectsizetoken|.
    \item \declare{\texttt{\textbackslash{}pgfsyssoftpath@rectsizetoken}} indicates the size of a
        rectangle on the soft path.
    \item \declare{\texttt{\textbackslash{}pgfsyssoftpath@closepath}} indicates that the subpath
